<template>
  <div class="card-container">
    ...
    <h4>{{ city }}</h4>
    <p>City</p>
    <div v-if="email !== emailUser" class="button">
      <a :href="'mailto:'+email+'?Subject=Factset%20Team%20App'">
...
<script>
export default {
  props: ["id", "email", "firstName", "lastName", "team", "city", "rol", "skills"],
  computed: {
    fullName() {
